        ...
        <div class="pdetails videos-pdetails">
            ...
            <div class="videos-form-wrapper">
                ...
                <form id="formFileUpload" action="{{ route('dashboard.videos.store') }}" method="POST" enctype="multipart/form-data" class="videos-upload-card" style="margin-bottom: 25px; border: 1px solid #cbd5e1; background: #ffffff; border-radius: 16px; padding: 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.03);">
                    ...
                    <div id="inlineVideoUploadProgressBox" style="display: none; margin-top: 16px; background: #f0fdf4; border: 1.5px solid #10b981; border-radius: 14px; padding: 16px; box-shadow: 0 4px 14px rgba(16,185,129,0.15);">
                        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px;">
                            <span id="inlineVideoTitle" style="font-weight: 800; font-size: 0.88rem; color: #065f46; display: flex; align-items: center; gap: 6px;">
                                <i class="bi bi-arrow-repeat spin-icon" style="color: #10b981; font-size: 1.1rem;"></i>
                                <span>{{ __('Uploading & Processing Video...') }}</span>
                            </span>
                            <span id="inlineVideoPercentBadge" style="font-weight: 800; font-size: 0.82rem; color: #047857; background: rgba(16,185,129,0.15); padding: 2px 10px; border-radius: 20px;">
                                0%
                            </span>
                        </div>
